<div class="">
    <div
        class="mx-auto overflow-hidden shadow-lg bg-gray-900 border-4 rounded-lg md:w-3/6 sm:w-4/6 border-gray-400">
        <div class="">
            ...
            <div class="py-5">
                ...
                <div class="flex items-stretch bg-gray-900 h-24">
                    ...
                    <x-calculator.button wire:click="operation('x')">×</x-calculator.button>
                </div>
